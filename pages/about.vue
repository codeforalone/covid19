<template>
  <div class="About">
    ...
    <TextCard>
      当サイトは新型コロナウイルス感染症（COVID-19）に関する最新情報を提供するために、東京都が開設したサイトのソースコードをもとに、非公式ですが愛知県版として作成したものです。<br />
      <br />
      愛知県による公式情報と客観的な数値をわかりやすく伝えることで、愛知県にお住まいの方や、愛知県内に拠点を持つ企業の方、愛知県を訪れる方が、現状を把握して適切な対策を取れるようにすることを目的としています。<br />
      <br />
      愛知県から同様の公式サイトがリリースされた場合は本サイトは終了する予定です。
    </TextCard>
    ...
    <TextCard title="データについて">
      本サイトで公表しているデータは、愛知県が公開しているWebサイトより取得したものから生成しています。
    </TextCard>
